...
<Story
  name="playground"
  args={{ minWidth: 200, placement: 'bottom' }}
...
>
  {(args) => (
    <ActionMenu {...args}>
      ...
      <ActionMenu.Item onClick={() => console.log('Clone')}>
        Clone
      </ActionMenu.Item>
      <ActionMenu.Item onClick={() => console.log('Archive')}>
        Archive
      </ActionMenu.Item>
...
const App = (props) => {
  ...
  return (
    <>
      <Box cursor="pointer" ref={triggerRef}>
        I am the trigger 😄
      </Box>
...
<Canvas>
  ...
  >
    {(args) => (
      <ActionMenu {...args}>
        <ActionMenu.Item onClick={() => console.log('Default')}>
          Default
        </ActionMenu.Item>
