  ...
  <Story name="enter timing" parameters={getFixedStoryParams()}>
    {(args) => (
      <Popover>
        ...
        <Popover.Content enterDelay={1000}>
  ...
  <Story name="exit timing" parameters={getFixedStoryParams()}>
    {(args) => (
      <Popover>
        ...
        <Popover.Content exitDelay={3000}>
  ...
  <Story name="not interactive" parameters={getFixedStoryParams()}>
    {(args) => (
      <Popover>
        ...
        <Popover.Content isInteractive={false}>
          I'm hiding when you mouse out the icon
        </Popover.Content>
      </Popover>
    )}
  </Story>
  <Story name="interactive" parameters={getFixedStoryParams()}>
    {(args) => (
      <Popover>
        ...
        <Popover.Content isInteractive={true}>
          I keep opened if you hover me
        </Popover.Content>
      </Popover>
    )}
  </Story>
  ...
  <Story name="on hover" parameters={getFixedStoryParams()}>
    {(args) => (
      <Popover>
        ...
        <Popover.Content trigger="mouseenter focus">
          You hovered it!
        </Popover.Content>
      </Popover>
    )}
