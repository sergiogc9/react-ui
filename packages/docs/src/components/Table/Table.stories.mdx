...
<Meta
	...
	argTypes={{ forceEmpty: { control: 'boolean' }, showAllBorders: { control: 'boolean' } }}
/>
...
<Story name="playground" parameters={getPlaygroundStoryParams()}>
	{args => (
		<Table {...args} width="90vw">
			...
			<Table.Content minWidth={1280} showAllBorders={args.showAllBorders} />
			<Table.Empty>
...
<ArgsTable of={Table.GlobalFilter} />

## Table.Empty API

<ArgsTable of={Table.Empty} />
