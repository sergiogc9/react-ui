...
<Canvas>
  ...
  <Story
    name="showing name initials"
    title="showing name initials"
    parameters={getFixedStoryParams()}
  >
...
<Canvas>
  <Story
    name="showing circle avatar"
    title="showing circle avatar"
    parameters={getFixedStoryParams()}
  >
    <Avatar src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=934&q=80" />
  </Story>
  <Story
    name="showing rounded avatar"
    title="showing rounded avatar"
    parameters={getFixedStoryParams()}
  >
    <Avatar
      variant="rounded"
