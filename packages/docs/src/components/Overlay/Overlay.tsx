...
const OverlayDocsStory = (props: Partial<OverlayProps>) => {
	const [isVisible, setIsVisible] = React.useState(false);

	return (
		<>
			<Button onClick={() => setIsVisible(v => !v)} zIndex={9999}>
				Toggle overlay
			</Button>
			<Overlay {...props} isVisible={isVisible} />
		</>
	);
};

export { OverlayDocsStory, OverlayPlaygroundStory };
