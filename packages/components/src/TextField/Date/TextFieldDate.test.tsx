...
describe('TextFieldDate component', () => {
  ...
  it('should render input', () => {
    ...
    expect(
      container.querySelector('input[value="May 11, 2020"]')
    ).toBeInTheDocument();
  });
  ...
  it('should render input with default value', () => {
    ...
    expect(
      container.querySelector('input[value="May 20, 2020"]')
    ).toBeInTheDocument();
  });
  ...
  it('should render input with correct locale', () => {
    ...
    expect(
      container.querySelector('input[value="11 de maig de 2020"]')
    ).toBeInTheDocument();
  });
  ...
  it('should change input value after selecting new date', () => {
    ...
    expect(
      container.querySelector('input[value="May 25, 2020"]')
    ).toBeVisible();
  });
  ...
  it('should call on change handler', () => {
    ...
    expect(mockOnChange).toHaveBeenCalledWith(
      new Date('2020-05-25T12:00:00.000Z')
    );
  });
