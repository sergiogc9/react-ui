...
const StyledStepperCircleLine: React.FC<StyledStepperCircleLineProps> = styled(
  Box
)<StyledStepperCircleLineProps>`
  ${variant}

  background-color: ${(props) =>
    getColorFromTheme(
      props.theme,
      props.theme.components.stepper.colors.disabledLine
    )};
  ...
  &::after {
    ...
    background-color: ${(props) =>
      getColorFromTheme(
        props.theme,
        props.theme.components.stepper.colors.active
      )};
