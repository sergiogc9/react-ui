...
const renderButton = (props?: Partial<ButtonProps>, children: React.ReactNode | React.ReactNode[] = btnText) =>
	render(
		withTheme(
...
describe('Button component', () => {
	...
	it('should render correct size', () => {
		...
		const button = screen.getByTestId(buttonTestId);
		expect(button).toHaveStyle(`height: ${theme.components.button.heights.l}px;`);
	});
	...
	it('should render correct variant', () => {
		...
		expect(button).toHaveStyle(
			`background-color: ${getColorFromTheme(theme, theme.components.button.colors.warning.background.default)}FF;`
		);
	});
	...
	it('should render correct link variant', () => {
		...
		const button = screen.getByTestId(buttonTestId);
		expect(button).toHaveStyle(
			`background-color: ${getColorFromTheme(theme, theme.components.button.colors.link.background.default)};`
		);
	});
