...
const renderDatePickerDay = (props?: Partial<DatePickerDayProps>) =>
  render(
    withTheme(
      <DatePickerDay
        data-testid={datePickerDayTestId}
        onDayClick={mockOnDayClicked}
        {...props}
      />
    )
  );
...
describe('DatePickerDay component', () => {
  ...
  it('should not render any day as selected', () => {
    ...
    expect(
      container.querySelector('.DayPicker-Day.DayPicker-Day--selected')
    ).toBeNull();
  });
  ...
  it('should not render any day as selected in range', () => {
    ...
    expect(
      container.querySelector('.DayPicker-Day.DayPicker-Day--start')
    ).toBeNull();
    expect(
      container.querySelector('.DayPicker-Day.DayPicker-Day--end')
    ).toBeNull();
  });
  ...
  it('should call onDayClicked handler', () => {
    ...
    expect(mockOnDayClicked).toHaveBeenCalledWith(
      new Date('2020-05-20T12:00:00.000Z'),
      {},
      expect.anything()
    );
  });
