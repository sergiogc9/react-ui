...
const StyledDatePickerDay: React.FC<DatePickerDayProps> = styled(Flex)<DatePickerDayProps>`
	...
	.DayPicker-Day--start {
		${props =>
			ssCss({
				borderBottomLeftRadius: props.theme.components.datePicker.day.borderRadius,
	...
	.DayPicker-Day--end {
		${props =>
			ssCss({
				borderBottomRightRadius: props.theme.components.datePicker.day.borderRadius,
				borderTopRightRadius: props.theme.components.datePicker.day.borderRadius,
				paddingRight: '2px'
			})}
	}
