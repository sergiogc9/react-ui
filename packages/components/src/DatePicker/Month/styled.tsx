...
const StyledDatePickerMonth: React.FC<DatePickerMonthProps> = styled(
  Box
...
const StyledMonthBox: React.FC<StyledMonthBoxProps> = styled(
  Box
)<StyledMonthBoxProps>`
  ...
  ${(props) =>
    ...
    css({
      ...
      borderBottomLeftRadius:
        props.theme.components.datePicker.month.borderRadius,
