...
const renderDatePickerMonth = (props?: Partial<DatePickerMonthProps>) =>
	render(withTheme(<DatePickerMonth data-testid={datePickerMonthTestId} onMonthClick={mockOnMonthClick} {...props} />));
...
describe('DatePickerMonth component', () => {
	...
	it('should call onMonthClick handler', () => {
		...
		expect(mockOnMonthClick).toHaveBeenCalledWith(new Date('2021-11-01T00:00:00.000Z'));
	});
