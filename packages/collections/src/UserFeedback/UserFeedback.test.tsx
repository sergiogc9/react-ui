...
const componentTestId = 'userFeedback';
const text = 'Awesome text';
const title = 'Awesome title';
const renderComponent = (props: Partial<UserFeedbackProps> = {}) =>
	render(
		withTheme(
			<UserFeedback
...
describe('UserFeedback', () => {
	...
	it('should render image and title', () => {
		...
		const wrapper = screen.getByTestId(componentTestId);
	...
	it('should call on button click handler', () => {
		const mockOnButtonClick = jest.fn();
		renderComponent({ onButtonClick: mockOnButtonClick });

		userEvent.click(screen.queryByText(buttonText)!);
